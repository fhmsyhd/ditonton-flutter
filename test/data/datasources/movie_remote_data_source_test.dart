...
void main() {
  ...
  group('get Now Playing Movies', () {
    ...
    test(
      ...
      () async {
        // arrange
        when(mockHttpClient.get(buildUri('/movie/now_playing'))).thenAnswer(
          (_) async =>
    ...
    test(
      ...
      () async {
        // arrange
        when(
          mockHttpClient.get(buildUri('/movie/now_playing')),
  ...
  group('get Popular Movies', () {
    ...
    test(
      ...
      () async {
        // arrange
        when(mockHttpClient.get(buildUri('/movie/popular'))).thenAnswer(
    ...
    test(
      ...
      () async {
        // arrange
        when(
          mockHttpClient.get(buildUri('/movie/popular')),
        ).thenAnswer((_) async => http.Response('Not Found', 404));
        // act
  ...
  group('get Top Rated Movies', () {
    ...
    test('should return list of movies when response code is 200 ', () async {
      // arrange
      when(mockHttpClient.get(buildUri('/movie/top_rated'))).thenAnswer(
    ...
    test(
      ...
      () async {
        // arrange
        when(
          mockHttpClient.get(buildUri('/movie/top_rated')),
        ).thenAnswer((_) async => http.Response('Not Found', 404));
        // act
  ...
  group('get movie detail', () {
    ...
    test('should return movie detail when the response code is 200', () async {
      // arrange
      when(mockHttpClient.get(buildUri('/movie/$tId'))).thenAnswer(
        (_) async =>
    ...
    test(
      ...
      () async {
        // arrange
        when(
          mockHttpClient.get(buildUri('/movie/$tId')),
        ).thenAnswer((_) async => http.Response('Not Found', 404));
        // act
  ...
  group('get movie recommendations', () {
    ...
    test(
      ...
      () async {
        // arrange
        when(
          mockHttpClient.get(buildUri('/movie/$tId/recommendations')),
        ).thenAnswer(
  ...
  group('search movies', () {
    ...
    test('should return list of movies when response code is 200', () async {
      // arrange
      when(
        mockHttpClient.get(buildUri('/search/movie', {'query': tQuery})),
      ).thenAnswer(
        (_) async => http.Response(
